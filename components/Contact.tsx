...
export default function ContactUs() {
  return (
    <div className="bg-gradient-to-t from-green-100 via-white to-green-100 text-gray-800 min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-4xl bg-gray-100 rounded-lg shadow-xl p-8 border border-gray-200">
