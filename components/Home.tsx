...
const HeroSection = () => {
  return (
    <div className="bg-gradient-to-br from-white via-green-100 to-white min-h-screen w-screen flex items-start justify-center text-center px-4 py-12 md:py-0 ">
