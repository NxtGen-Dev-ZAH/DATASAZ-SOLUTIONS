    ...
    <footer className="bg-white dark:bg-gray-900 text-black dark:text-white py-12 border-t-2 border-black dark:border-gray-700 w-full">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="flex items-center mb-4">
              ...
              <div className="ml-4">
                <h1 className="text-xl md:text-2xl font-semibold text-green-500 dark:text-green-400">
                  DataSAZ
                  <br />
                  <span className="text-cyan-500 dark:text-cyan-400 ml-8 md:ml-12">Solutions</span>
                </h1>
              </div>
            </div>
            <p className="text-sm md:text-base text-gray-600 dark:text-gray-300 mb-6">
              The Architects of AI-Driven Transformation. We specialize in next-generation software 
              development, empowering businesses with AI-driven solutions, cloud-native applications, 
          ...
          <div>
            <h4 className="text-md font-semibold mb-4 text-gray-800 dark:text-white">Quick Links</h4>
          ...
          <div>
            <h4 className="text-md font-semibold mb-4 text-gray-800 dark:text-white">Our Services</h4>
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
              <li>AI Agents & Multi-Agent Systems</li>
              <li>Generative AI Applications</li>
              <li>Machine Learning & Deep Learning</li>
              <li>Microservices Architecture</li>
              <li>Serverless Computing & DevOps</li>
              <li>LLM Fine-tuning & RAG Systems</li>
            </ul>
          </div>
          
          <div>
            <h4 className="text-md font-semibold mb-4 text-gray-800 dark:text-white">Contact Us</h4>
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="text-center md:text-right">
              <div className="flex justify-center md:justify-end space-x-4 text-sm text-gray-500 dark:text-gray-400">
                ...
                <Link href="/company-policy" className="hover:text-cyan-400 transition-colors">
                  Company Policy
                </Link>
              </div>
            </div>
